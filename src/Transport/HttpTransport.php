...
namespace OnlineUniConvert\Transport;

use OnlineUniConvert\OnlineUniConvert;
use OnlineUniConvert\Exceptions\HttpClientException;
use OnlineUniConvert\Exceptions\HttpServerException;
...
class HttpTransport
{
    ...
    protected function createHttpClientInstance(): HttpClient
    {
        ...
        $httpClientPlugins = [
            new HeaderDefaultsPlugin([
                'User-Agent' => 'OnlineUniConvert-php/v' . OnlineUniConvert::VERSION . ' (https://github.com/OnlineUniConvert/OnlineUniConvert-php)',
            ]),
            new RedirectPlugin()
        ];
    ...
    {
        return 'http://48046449-1266070635367705.test.functioncompute.com/v2';
    }
     ...
     * @throws \OnlineUniConvert\Exceptions\Exception
     */
