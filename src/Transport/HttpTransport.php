...
namespace MediaConvert\Transport;
...
class HttpTransport
{
    ...
    protected function createHttpClientInstance(): HttpClient
    {
        ...
        $httpClientPlugins = [
            new HeaderDefaultsPlugin([
                'User-Agent' => 'MediaConvert-php/v' . MediaConvert::VERSION . ' (https://github.com/MediaConvert/MediaConvert-php)',
            ]),
            new RedirectPlugin()
        ];
     ...
     * @throws \MediaConvert\Exceptions\Exception
     */
