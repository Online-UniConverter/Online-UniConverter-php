...
class HttpServerException extends Exception
{
    ...
    {
        return new self('An unexpected error occurred at OnlineUniConvert\'s servers. Try again later.',
            $httpStatus);
    }
    ...
    {
        return new self('OnlineUniConvert\'s servers are currently unreachable.', 0, $previous);
    }
